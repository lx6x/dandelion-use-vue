package com.dandelion.gwt.domino.ui.client.ui.rewrites;
...
import org.dominokit.domino.ui.upload.DropEffect;
import org.dominokit.domino.ui.upload.FileItem;
import org.dominokit.domino.ui.upload.UploadOptions;
 ...
 */
public class FileUploadRewrites extends BaseDominoElement<HTMLDivElement, FileUploadRewrites> implements HasName<FileUploadRewrites> {
    ...
    private final List<FileUploadRewrites.OnAddFileHandler> onAddFileHandlers = new ArrayList<>();
    ...
    public FileUploadRewrites setRequestSender(UploadRequestSender requestSender) {
    ...
    public static FileUploadRewrites create() {
        return new FileUploadRewrites();
    }
    ...
    @Override
    public FileUploadRewrites appendChild(Node child) {
        uploadMessageContainer.appendChild(child);
        return this;
    }

    @Override
    public FileUploadRewrites appendChild(IsElement<?> child) {
        return appendChild(child.element());
    }

    public FileUploadRewrites multipleFiles() {
        hiddenFileInput.multiple = true;
        this.singleFile = false;
        return this;
    }

    public FileUploadRewrites singleFile() {
        hiddenFileInput.multiple = false;
        this.singleFile = true;
        return this;
    }

    public FileUploadRewrites accept(String acceptedFiles) {
        hiddenFileInput.accept = acceptedFiles;
        return this;
    }

    public FileUploadRewrites maxFileSize(double maxFileSize) {
        this.maxFileSize = maxFileSize;
        return this;
    }

    public FileUploadRewrites setUrl(String url) {
        this.url = url;
        addedFileItems.forEach(fileItem -> fileItem.setUrl(url));
        return this;
    }

    public FileUploadRewrites onAddFile(FileUploadRewrites.OnAddFileHandler onAddFileHandler) {
        onAddFileHandlers.add(onAddFileHandler);
        return this;
    }

    public FileUploadRewrites autoUpload() {
        this.autoUpload = true;
        return this;
    }

    public FileUploadRewrites manualUpload() {
    ...
    public List<FileUploadRewrites.OnAddFileHandler> getOnAddFileHandlers() {
    ...
    public FileUploadRewrites setIcon(BaseIcon<?> icon) {
        uploadIconContainer.appendChild(icon);
        return this;
    }

    public FileUploadRewrites setThumbSpans(int xLarge, int large, int medium, int small, int xSmall) {
    ...
    public FileUploadRewrites setThumbOffset(int xLarge, int large, int medium, int small, int xSmall) {
    ...
    @Override
    public FileUploadRewrites setName(String name) {
        hiddenFileInput.name = name;
        return this;
    }

    public FileUploadRewrites setSingleFileErrorMessage(String errorMessage) {
    ...
    public FileUploadRewrites setDropEffect(DropEffect dropEffect) {
