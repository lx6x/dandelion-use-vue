...
public class RedisUtil {
    ...
    public long getExpire(String key) {
        ...
        Long date = redisTemplate.getExpire(key, TimeUnit.SECONDS);
        return null != date ? date : -1;
    }
     ...
     * @return true成功 false 失败
     */
    public boolean set(String key, Object value, long time, final TimeUnit timeUnit) {
        try {
            if (time > 0) {
...
//        return null != increment ? increment : 0;
        return increment;
    }
...
//        return null != increment ? increment : 0;
    ...
    public boolean sHasKey(String key, Object value) {
        try {
            ...
            return null != member ? member : false;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
